...
🛠️ Technical Toolkit
Languages: Python (Expert), C++ (Embedded/MCU focused) and the Qt framework 
...
Tools: Git/GitHub, Linux, Jupyter Notebooks
 ...
 Current Focus
Developing efficient Machine Learning models for resource-constrained environments (Lite RT).
